# New York City Public School Test Results Analysis
![NYC](https://github.com/user-attachments/assets/9e9e2b27-a34b-4c87-830f-d639e7b09a01)
## Project Overview:
...
- **Data Manipulation:**
  ...
  - ```NumPy```: A library for numerical computing, offering support for large, multi-dimensional arrays and matrices, along with a collection of mathematical functions.
...
- **Data Visualisation:** 
  - ```Matplotlib```: A comprehensive library for creating static, animated, and interactive visualizations in Python, widely used for plotting graphs.
...
## Source Data
The data that I will be using is from *DataCamp*. Here's the link to access the dataset: https://www.datacamp.com/projects/1596.
